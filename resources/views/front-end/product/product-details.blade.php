                ...
                <div class="col-md-7 single-top-left ">
                    <div class="single-right">
                        ...
                        <div class="add add-3">
                            ...
                            <button type="submit" class="btn btn-danger my-cart-btn my-cart-b" data-image="{{asset('/')}}front/images/si.jpg">Add to Cart</button>
                        </div>
                        {{Form::close()}}
                ...
                <div class="col-md-3 pro-1">
                    <div class="col-m">
                        ...
                        <div class="mid-1">
                            ...
                            <div class="add">
                                <button class="btn btn-danger my-cart-btn my-cart-b" data-image="{{asset('/')}}front/images/of4.png">Add to Cart</button>
                            </div>
                        </div>
                    </div>
                </div>
