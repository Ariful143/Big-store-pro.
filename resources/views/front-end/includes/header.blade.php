<div class="header">
    ...
    <div class="container">
        ...
        <div class="logo">
            <h1 ><a href="{{route('/')}}"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h1>
        </div>
        <div class="head-t">
            <ul class="card">
                ...
                <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                    <ul class="nav navbar-nav ">
                        ...
                        @foreach($categories as $category)
                            <li><a href="{{route('category-product',['id'=>$category->id])}}" class="hyper"> <span>{{$category->category_name}}</span></a></li>
                        @endforeach
